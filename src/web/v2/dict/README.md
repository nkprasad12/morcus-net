...
Companion docs: [`PREFERENCES.md`](PREFERENCES.md) explains how preferences are stored and resolved, [`FEATURE_PARITY.md`](FEATURE_PARITY.md) tracks the V1 → V2 gap, and [`TODOS.md`](TODOS.md) records known follow-up work.
