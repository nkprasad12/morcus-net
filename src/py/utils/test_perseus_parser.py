...
class TestStringMethods(unittest.TestCase):
    ...
    def test_handles_add_tags(self):
        result = perseus_parser.parse_perseus_xml('testdata/perseus/doc_with_splits.xml')
    ...
    def test_handles_multiple_nesting(self):
        result = perseus_parser.parse_perseus_xml('testdata/perseus/doc_with_books_chapters_sections.xml')
