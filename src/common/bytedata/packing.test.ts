...
describe("pack and unpacking integer arrays", () => {
  describe("packSortedNats and unpackIntegers", () => {
    ...
    it("throws error for out-of-range values", () => {
      expect(() => packSortedNats([-1])).toThrow();
    });
    ...
    it("throws error for unsorted values", () => {
      expect(() => packSortedNats([1, 0])).toThrow();
      expect(() => packSortedNats([0, 2, 1])).toThrow();
    });
  });
  ...
  describe("PackedNumbers", () => {
    ...
    describe("hasValueInRange", () => {
      ...
      it("should return false for an empty packed array", () => {
        const emptyPacked = packSortedNats([]);
