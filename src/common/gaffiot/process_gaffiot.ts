...
export const GAFFIOT_TAGS = [
  ...
  "hbox",
  "gras", // bold
  "S", // Section symbol §, may be followed by a number
  ...
  "times", // times symbol
  "raise", // Means raised up, we can ignore it. Has a unit immediately after
  "arabe", // Arabic
  ...
  "hskip", // has a unit e.g. \\hskip0.3em immediately after
