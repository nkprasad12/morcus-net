...
- Update the `nginx` version, (currently `1.30.4-alpine-slim`). Due _before_ it goes EOL in `2027/04`ish.
  - Update the `nginx` version in `src/devops/reverse_proxy/Dockerfile`
