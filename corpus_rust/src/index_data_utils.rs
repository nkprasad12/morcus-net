...
impl IndexData {
    ...
    pub fn num_elements(&self) -> usize {
        match self {
            IndexData::BitMask(bitmask_data) => bitmask_data
                .data
                .iter()
...
mod tests {
    ...
    fn num_elements_packed_bitmask_should_return_set_bits_count() {
        ...
        let data = IndexData::BitMask(BitMask { data: bitmask_data });
